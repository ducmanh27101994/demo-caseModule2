...
<a style="margin-right: 20px" href="index.php?page=list-category">CATEGORYS</a>
...
<a style="margin-right: 20px" href="index.php?page=add-borrow">ADD BORROWS</a>

<a style="margin-right: 20px" href="index.php?page=view-order">VIEW CARD</a>
<a style="margin-right: 20px" href="index.php?page=list-borrow">RETURN BORROWS</a>
